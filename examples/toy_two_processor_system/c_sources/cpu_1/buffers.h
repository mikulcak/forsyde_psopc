/** @file
 * @brief The header file for CPU 1, containing all CPU-specific information necessary to use the communication functions.
 */
...
// The current CPU is not connected to a DMA controller.
/** Turn off the usage of DMA controllers in the communication functions.*/
#define DMA 0
